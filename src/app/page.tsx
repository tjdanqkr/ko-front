  ...
  return (
    <div className="flex flex-col items-center bg-gradient-to-b p-8">
      ...
      <div className="flex space-x-6">
        <a href="https://github.com/tjdanqkr/ko-front" className="px-6 py-3 bg-white text-blue-500 rounded-full font-semibold shadow-lg hover:bg-blue-100 transition">
          프론트엔드 GitHub
        </a>
